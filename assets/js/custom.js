...
window.onload = function() {
  ...
  const introMotion = gsap.timeline({
    onStart: function() {
      ...
      lenis.stop();
      videolEls.forEach(function (video) {
        video.pause();
      })
    },
    onComplete: function() {
  ...
  introMotion
    .to('.loading__content:nth-child(2)', {y: 0}, 'a1+=.2')
    .to('.loading .marquee__texts', {x: 0, duration: 1.1}, 'a1+=.2')
    .to('.loading__content:nth-child(1)', {yPercent: -130, y: -20, duration: 1}, 'a2+=1')
